...
$sql="select * from user_info where user_phone =".$user_phone;
...
//  $jsontext = '{"title":"通知标题","content":"通知内容","payload":"通知去干嘛这里可以自定义"}';
    $jsontext = '{title:"掌上健康",content:"您咨询的医生给你开了处方",payload:"'.$doc_phone.'"}';
