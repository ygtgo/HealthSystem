...
<body>
<form method="post" action="/health/management/Application/index.php/Admin/User/listUser/p/3.html" id="listform">
  <div class="panel admin-panel">
    ...
    <?php foreach ($data as $k => $v): ?>
        <tr>
          ...
          <td>
          <a style="cursor:pointer" onclick="showDialog(<?php echo $v['user_id']; ?>)">查看</a>
          <a href="/health/management/Application/index.php/Admin/User/edit/user_id/<?php echo $v['user_id']; ?>">修改</a> 
          <a style="cursor:pointer" onclick="del(<?php echo $v['user_id']; ?>)"> 删除</a></br>
          <a href="/health/management/Application/index.php/Admin/HistoryVis/listHis/user_id/<?php echo $v['user_id']; ?>/relative_id/0">历史就诊</a>
          <a href="/health/management/Application/index.php/Admin/User/edit/user_id/<?php echo $v['user_id']; ?>">用药日记</a>
          <a href="/health/management/Application/index.php/Admin/relative/listRela/user_id/<?php echo $v['user_id']; ?>">亲友管理</a>
          </td>
          <td colspan="0">
          	<!-- 详情页面 -->
